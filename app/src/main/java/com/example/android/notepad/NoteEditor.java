...
public class NoteEditor extends Activity {
    ...
    private static final String[] PROJECTION =
        new String[] {
            ...
            NotePad.Notes.COLUMN_NAME_TAG // 查询标签字段
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mText = findViewById(R.id.note); // Note 编辑框
    ...
    protected void onResume() {
        ...
        if (mCursor != null) {
            ...
            String currentTag = mCursor.getString(colTagIndex);
            Spinner tagSpinner = findViewById(R.id.tag_spinner);
            ArrayAdapter<String> adapter = (ArrayAdapter<String>) tagSpinner.getAdapter();
            int position = adapter.getPosition(currentTag);
            tagSpinner.setSelection(position);

            // 设置背景颜色
            setEditorBackground(currentTag);
    ...
    protected void onPause() {
        ...
        if (mCursor != null) {
            ...
            if (isFinishing() && (length == 0)) {
                ...
                updateNote(text, text, selectedTag);
                mState = STATE_EDIT;
          }
        }
    }
            ...
            if (uri != null && NotePad.Notes.CONTENT_ITEM_TYPE.equals(cr.getType(uri))) {
                ...
                if (orig != null) {
                    if (orig.moveToFirst()) {
                        ...
                        tag = orig.getString(colTagIndex);
                    }
...
//END_INCLUDE(paste)
     ...
     */
    private final void updateNote(String text, String title, String selectedTag) {
